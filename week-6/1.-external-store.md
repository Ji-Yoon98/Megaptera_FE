...
- [Separation of Concerns](1.-external-store#separation-of-concerns)
- [Flux Architecture](1.-extemal-store#flux-architecture)
- [External Store](1.-extemal-store#external-store)
